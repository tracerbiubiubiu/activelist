...
| 里程碑 | 内容 | 依赖 | 退出标准 |
|--------|------|------|---------|
| M-A1 骨架 | go.mod（引 zhuzhao-utils）、config 加载、migrations 000001（元数据表）、docker-compose（PG）、healthz/readyz、优雅停止 | ✅ 已就绪（2026-09-03 验证，见 ADR-003 D1 验证记录）——**可立即开工** | 服务起 + 健康检查过 |
